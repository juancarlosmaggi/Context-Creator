...
# Generate a large set of Path objects
num_elements = 100000
elements_set = {Path(f"/path/to/some/file_{i}.txt") for i in range(num_elements)}
...
if __name__ == "__main__":
    time_with_list = timeit.timeit(sort_with_list, number=10)
    time_without_list = timeit.timeit(sort_without_list, number=10)
